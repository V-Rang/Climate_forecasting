...
class EncoderLayer(nn.Module):
    def __init__(self, attention_mech, d_model, d_exp = None, dropout = 0.1, activation="relu"):
        ...
        self.conv1 = nn.Conv1d(in_channels = d_model, out_channels = d_exp, kernel_size = 1)
        self.conv2 = nn.Conv1d(in_channels = d_exp, out_channels = d_model, kernel_size = 1)
