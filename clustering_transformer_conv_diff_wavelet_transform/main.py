...
input_settings['obs_path'] = "snapshots_2d.npy"
...
input_settings['pred_len'] = 10 # t-instances output by model 
...
input_settings['wavelet_transformation'] = 1 # to perform wavelet transform in data-preprocessing step or not.
...
exp_name = '{}_{}-sl{}-dm{}-pl{}-bs{}-ne{}-lr{}-el{}_with_attention_timenc'.format(
